...
<head>
    ...
    <link rel="icon" href="<?php echo verificarAdmin('../img/iconos/sinfiltrocafe_logo.svg','./img/iconos/sinfiltrocafe_logo.svg','../../../img/iconos/sinfiltrocafe_logo.svg'); ?>" type="image/x-icon">
